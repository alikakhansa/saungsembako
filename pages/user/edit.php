...
<div class="row" style="width: 92%; margin: 0 auto; margin-top: 20px;">
   <div class="col-sm-12">
      <div class="page-title-box">
         ...
         <h3  class="page-title">Edit Data Uer</h3>
      </div>
   </div>
</div>
<?php
...
<form action="#" method="post"  enctype="multipart/form-data">
   <div class="form-group">
      ...
      <input type="text" class="form-control" name="USERNAME" style="color: black; width: 100%" value="<?php echo $USERNAME; ?>" required>
   </div>
      <div class="form-group">
  ...
  <div class="form-group">
         ...
         while ($row = mysqli_fetch_assoc($result)) : ?>
            <option value="<?php echo $row['LEVEL']; ?>"<?php if($row['LEVEL']==$LEVEL){echo "selected";}?>><?php echo $row['LEVEL']; ?></option>
         <?php endwhile; ?>
      </select>
                </div>
